...
# Visualise heatmap plot
print(heatmap_plot)

# Save heatmap plot
ggsave("~/GIT/L4137_HBEC_EV_Transcriptomics-Project/write_up/drafts/figures/supplementary/Supp_Figure_3/panels/heatmap_plot.svg", plot = heatmap_plot, width=10, height=7, units='in')
