...
# Save MA plot
ggsave("~/GIT/L4137_HBEC_EV_Transcriptomics-Project/write_up/drafts/figures/main/figure_3/panels/MA_plot.svg", plot = ma_plot, width=10, height=7, units='in')
...
saveWidget(
  ...
  "~/GIT/L4137_HBEC_EV_Transcriptomics-Project/write_up/drafts/figures/main/figure_3/panels/MA_plot.html",
  selfcontained = TRUE
)
