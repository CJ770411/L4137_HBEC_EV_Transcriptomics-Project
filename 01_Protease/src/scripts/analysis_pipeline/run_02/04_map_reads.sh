...
#SBATCH --output=../../logs/analysis_pipeline/run_02/04_map_reads/slurm-%x-%j.out               # Standard output log file ("%x" is replaced with job name, "%j" is replaced with job ID)
#SBATCH --error=../../logs/analysis_pipeline/run_02/04_map_reads/slurm-%x-%j.err                # Standard error log file ("%x" is replaced with job name, "%j" is replaced with job ID)
...
LOG_DIR=$(realpath "../../logs/analysis_pipeline/run_02/04_map_reads")
...
INDIR_TRIMMED_READS="${PROJECT_ROOT}/results/analysis_pipeline/run_02/01_raw_read_trimming/cutadapt"
...
OUTDIR_MAP="${PROJECT_ROOT}/results/analysis_pipeline/run_02/04_map_reads/mapper"
