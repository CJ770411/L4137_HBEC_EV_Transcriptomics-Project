...
#SBATCH --output=../../../logs/primaryHBEC/01_raw_read_trimming/slurm-%x-%j.out               # Standard output log file ("%x" is replaced with job name, "%j" is replaced with job ID)
#SBATCH --error=../../../logs/primaryHBEC/01_raw_read_trimming/slurm-%x-%j.err                # Standard error log file ("%x" is replaced with job name, "%j" is replaced with job ID)
...
LOG_DIR=$(realpath "../../../logs/primaryHBEC/01_raw_read_trimming")
...
OUTDIR_CUTADAPT="${PROJECT_ROOT}/results/primaryHBEC/01_raw_read_trimming"
