...
#SBATCH --output=../../../logs/primaryHBEC/02_reads_qc/slurm-%x-%j.out               # Standard output log file ("%x" is replaced with job name, "%j" is replaced with job ID)
#SBATCH --error=../../../logs/primaryHBEC/02_reads_qc/slurm-%x-%j.err                # Standard error log file ("%x" is replaced with job name, "%j" is replaced with job ID)
...
LOG_DIR=$(realpath "../../../logs/primaryHBEC/02_reads_qc")
...
RAW_READS=(${PROJECT_ROOT}/test_data/primaryHBEC/*fastq.gz)
TRIMMED_READS=("${PROJECT_ROOT}"/results/primaryHBEC/01_raw_read_trimming/*.fastq.gz) 
...
# 1. FastQC
# 2. miRTrace
INDIR_SAMPLE_REPORTS_RAW="${PROJECT_ROOT}"/results/primaryHBEC/02_reads_qc/raw
INDIR_SAMPLE_REPORTS_TRIMMED="${PROJECT_ROOT}"/results/primaryHBEC/02_reads_qc/trimmed
...
OUTDIR_RAW="${PROJECT_ROOT}/results/primaryHBEC/02_reads_qc/raw"
OUTDIR_TRIMMED="${PROJECT_ROOT}/results/primaryHBEC/02_reads_qc/trimmed"
