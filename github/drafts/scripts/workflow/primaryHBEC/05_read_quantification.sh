...
#SBATCH --output=../../../logs/primaryHBEC/05_read_quantification/slurm-%x-%j.out               # Standard output log file ("%x" is replaced with job name, "%j" is replaced with job ID)
#SBATCH --error=../../../logs/primaryHBEC/05_read_quantification/slurm-%x-%j.err                # Standard error log file ("%x" is replaced with job name, "%j" is replaced with job ID)
...
LOG_DIR=$(realpath "../../../logs/primaryHBEC/05_read_quantification")
...
COLLAPSED_FILES="${PROJECT_ROOT}/results/primaryHBEC/04_collapse_reads/mapper"
...
OUTDIR_SAMPLE="${PROJECT_ROOT}/results/primaryHBEC/05_read_quantification/${SAMPLE_NAME}"

#       Directory containing only count matrices for all samples
OUTDIR_ALL_SAMPLES="${PROJECT_ROOT}/results/primaryHBEC/05_read_quantification/all_samples"
