...
indir_all_counts <- "~/GIT/L4137_HBEC_EV_Transcriptomics-Project/02_HDM_Dog/results/analysis_pipeline/run_01/05_read_quantification"
...
colnames(count_matrix) <- c("Symbol", 
                            ...
                            "Poly_IC__1", "Poly_IC__2", "Poly_IC__3",
...
write_tsv(edgeR_count_matrix, "~/GIT/L4137_HBEC_EV_Transcriptomics-Project/02_HDM_Dog/results/analysis_pipeline/run_01/06_create_count_matrix/edgeR_count_matrix.txt")
...
write.csv(deseq2_count_matrix, "~/GIT/L4137_HBEC_EV_Transcriptomics-Project/02_HDM_Dog/results/analysis_pipeline/run_01/06_create_count_matrix/deseq2_count_matrix.csv", row.names=TRUE)
